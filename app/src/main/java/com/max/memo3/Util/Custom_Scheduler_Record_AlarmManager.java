        ...
        extends RealmObject
{
    ...
    public PendingIntent makePendingIntent(){
        PendingIntent pendingIntent = PendingIntent.getBroadcast(util.APP_CONTEXT,requestCode,makeIntent(),0);
        return pendingIntent;
    }
    public PendingIntent makePendingIntent(Intent intent){
        PendingIntent pendingIntent = PendingIntent.getBroadcast(util.APP_CONTEXT,requestCode,intent,0);
        return pendingIntent;
    }
